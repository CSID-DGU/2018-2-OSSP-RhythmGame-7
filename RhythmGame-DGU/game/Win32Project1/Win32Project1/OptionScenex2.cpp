...
void OptionScenex2::Init()
{

	_X1 = new Font_o("arialbd.ttf", 24);
	_X2 = new Font_o_s("arialbd.ttf", 24);
...
void OptionScenex2::Deinit()
{

	delete _backgroundSprite;
}

void OptionScenex2::Update(int deltaTime)
{
...
void OptionScenex2::KeyUp(unsigned int keyCode)
{
...
void OptionScenex2::KeyDown(unsigned int keyCode)
{
}

OptionScenex2* OptionScenex2::bpm()
{
	return _bpm;
}
float OptionScenex2::getbpm(float bpmnum)
{
	return bpmnum;
}