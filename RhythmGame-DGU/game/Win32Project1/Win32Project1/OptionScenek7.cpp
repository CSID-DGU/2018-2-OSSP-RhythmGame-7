...
void OptionScenek7::Init()
{
	...
	_K7 = new Font_o_s("arialbd.ttf", 24);
...
void OptionScenek7::Deinit()
{

	delete _backgroundSprite;
}

void OptionScenek7::Update(int deltaTime)
{
...
void OptionScenek7::KeyUp(unsigned int keyCode)
{
...
void OptionScenek7::KeyDown(unsigned int keyCode)
{
}

OptionScenek7* OptionScenek7::bpm()
{
	return _bpm;
}
float OptionScenek7::getbpm(float bpmnum)
{
	return bpmnum;
}