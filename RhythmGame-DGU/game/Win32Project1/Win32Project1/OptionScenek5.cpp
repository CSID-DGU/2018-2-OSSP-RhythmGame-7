...
void OptionScenek5::Deinit()
{

	delete _backgroundSprite;
}

void OptionScenek5::Update(int deltaTime)
{
...
void OptionScenek5::KeyUp(unsigned int keyCode)
{
...
void OptionScenek5::KeyDown(unsigned int keyCode)
{
}

OptionScenek5* OptionScenek5::bpm()
{
	return _bpm;
}
float OptionScenek5::getbpm(float bpmnum)
{
	return bpmnum;
}